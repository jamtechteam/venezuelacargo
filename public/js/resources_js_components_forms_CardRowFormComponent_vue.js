"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_forms_CardRowFormComponent_vue"],{
      ...
      this.$validator.validate().then(function (valid) {
        if (valid) {
          ...
          for (var field in formData) {
            ...
            if (_formatPrice__WEBPACK_IMPORTED_MODULE_0__.formatPrice.checkField(field)) {
