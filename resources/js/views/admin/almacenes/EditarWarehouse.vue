                        ...
                        <div class="d-flex align-items-center mt-5">
                            <div class=" m-0 ms-auto" style="width: 330px;">
                                <div class="form-floating mb-3 w-100">
                                    <input type="text" class="form-control" name="warehouse" v-model="solicitud.warehouse" id="warehouse" >
    ...
    beforeCreate(){
        this.$nextTick(async function () {
            if( Object.keys(this.$route.params).length != 0 ){
                ...
                await this.axios.get(`almacenes/${this.$route.params.id}`)
                .then(response => { 
                    setTimeout(() => {
    ...
    methods: {
        ...
        saveDataPaquete(){
            this.$validator.validate().then(valid => {
                if( valid ){
                    console.log(this.trackings[0].ruta_image)
                    if( this.dato.image != '' || this.trackings[0].ruta_image != ''){
                        ...
                        for (let i = 0; i < this.trackings.length; i++) {
                            if( this.trackings[i].id_tracking == this.dato.id_tracking ){
                                ...
                                this.trackings[i].ruta_image =  this.imagenMiniatura != '' ? this.imagenMiniatura : this.trackings[i].ruta_image;
                                this.trackings[i].image = this.dato.image != '' ? this.dato.image : '';
                            }
                        }
        ...
        savePaquete(){
            ...
            for (let i = 0; i < paquetes.length; i++) {
                ...
                const apiUrl = 'almacenes-actualizar';
